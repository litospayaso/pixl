...
export const ConfigPlatforms = function(props: LevelProperties) {
    ...
    props.colorWalls.create(412, 1137).setDisplaySize(50, 130).setTintFill(0xfd5308).setAlpha(0.5).body.setSize(50, 130).setOffset(-10, -50).color = 'fd5308';
    props.colorWalls.create(250, 937).setDisplaySize(100, 200).setTintFill(0xfb9902).setAlpha(0.5).body.setSize(100, 200).setOffset(-35, -85).color = 'fb9902';
